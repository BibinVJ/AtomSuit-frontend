...
export default function EditPurchaseInvoice() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const pi = piData;
      setVendorId(String(pi.vendor_id));
      setInvoiceNumber(pi.invoice_number);
      setReferenceNumber(pi.reference_number || '');
      setPostingDate(pi.posting_date);
      setDueDate(pi.due_date);
      setCostCenterId(String(pi.cost_center_id || ''));
  ...
  if (!hasPermission('update-purchase-invoice')) {
  ...
  return (
    <>
      <PageMeta
        ...
        description={`Edit purchase invoice ${invoiceNumber}`}
      />
      <PageBreadcrumb pageTitle="Edit Purchase Invoice" />
