...
import SettingsGroup from '@/app/(dashboard)/settings/_components/SettingsGroup';
...
export default function Settings({ params }: { params: Promise<{ category: string }> }) {
  ...
  const currentCategory = unwrappedParams.category || 'general';
