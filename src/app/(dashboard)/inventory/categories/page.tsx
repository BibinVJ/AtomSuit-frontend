...
import CategoryTable from '@/app/(dashboard)/inventory/_components/categories/CategoryTable';
import AddCategoryModal from '@/app/(dashboard)/inventory/_components/categories/AddCategoryModal';
