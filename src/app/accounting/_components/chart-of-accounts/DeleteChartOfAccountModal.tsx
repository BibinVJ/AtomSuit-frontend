...
import { deleteChartOfAccount } from '@/services/ChartOfAccountService';
...
export default function DeleteChartOfAccountModal({
  isOpen,
  onClose,
  onSuccess,
  chartOfAccount,
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteChartOfAccount(chartOfAccount.id, force);
      toast.success(
        force
          ? 'Chart of Account permanently deleted successfully'
      ...
      <div className="relative w-full">
        <div className="p-4 text-center">
          ...
          <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
            {force ? 'Permanently Delete Account' : 'Delete Account'}
          </h4>
          <p className="mb-6 text-gray-500 dark:text-gray-400">
            Are you sure you want to {force ? 'permanently ' : ''}delete the account &quot;
            {chartOfAccount?.name}&quot;?{' '}
