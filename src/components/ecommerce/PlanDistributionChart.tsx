          ...
          return (
            <div key={item.name} className="flex items-center justify-between">
              <div className="flex items-center space-x-2 flex-1">
                ...
                />
                <span
                  className={`text-gray-700 dark:text-gray-300 ${isCompact ? 'text-xs' : 'text-sm'}`}
                >
                  {item.name}
                </span>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <div
                  className={`bg-gray-200 rounded-full h-1.5 dark:bg-gray-700 ${isCompact ? 'w-16' : 'w-20'}`}
                >
                  <div
                ...
                <div className="text-right min-w-[40px]">
                  <div
                    className={`font-semibold text-gray-900 dark:text-white ${isCompact ? 'text-xs' : 'text-sm'}`}
                  >
                    {item.value}
                  </div>
                </div>
