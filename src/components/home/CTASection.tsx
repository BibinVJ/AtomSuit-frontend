        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-xl text-brand-100 mb-8 leading-relaxed">
              Join thousands of businesses already using Atom Suit ERP to streamline their operations, 
              increase efficiency, and accelerate growth. Start your journey today.
            </p>
