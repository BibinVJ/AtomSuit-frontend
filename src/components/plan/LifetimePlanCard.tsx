...
export default function LifetimePlanCard({ 
  ...
  const defaultButtonStyle = 'bg-gradient-to-r from-yellow-400 to-orange-500 text-white hover:from-yellow-500 hover:to-orange-600 shadow-xl hover:shadow-2xl transform hover:scale-105';
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mb-6">
              <div className="flex items-baseline">
                ...
                <span className="ml-3 text-2xl text-purple-200">
                  once
                </span>
              </div>
