...
export default function AddChartOfAccountModal({ isOpen, onClose, onSuccess }: Props) {
  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        const response = await getAccountGroups({ perPage: 1000 });
  ...
  return (
    <FormModal
      ...
      description="Fill in the details to add a new chart of account."
        ...
        <div>
          ...
          <Select
            ...
            options={[
              ...
              ...accountGroups.map((group) => ({ value: group.id.toString(), label: group.name })),
            ]}
