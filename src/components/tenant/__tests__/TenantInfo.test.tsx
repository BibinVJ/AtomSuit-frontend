...
jest.mock('lucide-react', () => ({
  Building: ({ className }: { className?: string }) => <div data-testid="building-icon" className={className}>🏢</div>,
  Crown: ({ className }: { className?: string }) => <div data-testid="crown-icon" className={className}>👑</div>,
}))
