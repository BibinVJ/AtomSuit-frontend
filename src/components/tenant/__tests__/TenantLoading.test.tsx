...
jest.mock('lucide-react', () => ({
  AlertCircle: ({ className }: { className?: string }) => <div data-testid="alert-icon" className={className}>⚠️</div>,
}))
...
describe('TenantLoading', () => {
  ...
  it('shows error state', () => {
    ...
    expect(screen.getByText('You will be redirected to the main site shortly...')).toBeInTheDocument()
  ...
  it('applies correct CSS classes for loading state', () => {
    ...
    expect(loadingContainer?.parentElement).toHaveClass('min-h-screen', 'flex', 'items-center', 'justify-center')
  })
  ...
  it('applies correct CSS classes for error state', () => {
    ...
    expect(errorContainer?.parentElement).toHaveClass('min-h-screen', 'flex', 'items-center', 'justify-center')
  })
})