...
export default function DatePicker({
  ...
  if (error) {
    inputClasses += ` bg-white border-error-500 focus:border-error-300 focus:ring-error-500/20 dark:bg-gray-900 dark:text-error-400 dark:border-error-500 dark:focus:border-error-800`;
  } else {
    inputClasses += ` bg-white text-gray-800 border-gray-300 focus:border-brand-300 focus:ring-brand-500/20 dark:bg-gray-900 dark:border-gray-700 dark:focus:border-brand-800`;
  }
