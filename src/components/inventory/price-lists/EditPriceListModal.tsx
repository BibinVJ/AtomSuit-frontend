...
import { updatePriceList } from '../../../services/PriceListService';
...
export default function EditPriceListModal({ isOpen, onClose, onSuccess, priceList }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updatePriceList(priceList.id, payload);
      ...
      <div className="relative w-full">
        <div className="px-2 pr-14">
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Update the details for the price list.
          </p>
        </div>
